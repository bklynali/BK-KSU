...
import com.bk.ksu.KernelVersion
import com.bk.ksu.Natives
import com.bk.ksu.R
import com.bk.ksu.getKernelVersion
import com.bk.ksu.ui.LocalHandlePageChange
...
import com.bk.ksu.ui.util.checkNewVersion
import com.bk.ksu.ui.util.getModuleCount
import com.bk.ksu.ui.util.getSELinuxStatus
import com.bk.ksu.ui.util.getSuperuserCount
import com.bk.ksu.ui.util.module.LatestVersionInfo
import com.bk.ksu.ui.util.reboot
import com.bk.ksu.ui.util.rootAvailable
...
fun LearnMoreCard() {
    val uriHandler = LocalUriHandler.current
    val url = stringResource(R.string.home_learn_BK_KSU_url)
    ...
    Card(
        ...
        BasicComponent(
            title = stringResource(R.string.home_learn_BK_KSU),
            summary = stringResource(R.string.home_click_to_learn_BK_KSU),
            rightActions = {
                Icon(
