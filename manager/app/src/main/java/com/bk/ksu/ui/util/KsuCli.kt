...
fun flashModule(
    ...
    with(resolver.openInputStream(uri)) {
        ...
        Log.i("BK-KSU", "install module $uri result: $result")
...
fun runModuleAction(
    ...
    Log.i("BK-KSU", "Module runAction result: $result")
...
fun installBoot(
    ...
    val result = flashWithIO("${getKsuDaemonPath()} $cmd", onStdout, onStderr)
    Log.i("BK-KSU", "install boot result: ${result.isSuccess}")
